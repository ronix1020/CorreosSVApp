...
import { addItemTracking, ItemTracking } from '../redux/slices/tracking';
...
const Home = ({ navigation, route }: Props) => {
    ...
    if (tracking.items.length > 0) {
        return (
            ...
            <Appbar >
                <Appbar.Content title="Correos SV" titleStyle={{ fontWeight: 'bold' }}/>
                <Appbar.Action icon="archive-plus" color='#378991' onPress={() => { setVisible(true) }}/>
            </Appbar>
